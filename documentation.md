- [Api](#api)
  * [css(...rules)](#css-rules)
  * [css.global(selector, style) / css.insert(css)](#cssglobal-selector--style----cssinsert-css-)
  * [css.fontFace(font)](#cssfontface-font-)
- [css.keyframes(timeline)](#csskeyframes-timeline-)
  * [simulate(...pseudoclasses)](#simulate-pseudoclasses-)
  * [speedy(true/false)](#speedy-true-false-)
  * [`flush()`](#-flush---)
...
- [What happens when I call css(...rules)?](#what-happens-when-i-call-css-rules--)
...
- [inline (experimental)](#inline--experimental-)
